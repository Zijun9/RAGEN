...
def _select_rm_score_fn(data_source):
    ...
    elif "sokoban" in data_source or "sokoban_dual" in data_source or "frozenlake" in data_source or "bandit" in data_source:
...
@hydra.main(config_path='config', config_name='mppo_trainer', version_base=None)
def main(config):
